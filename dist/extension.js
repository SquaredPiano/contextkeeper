...
const LintingService_1 = __webpack_require__(8);
const ContextIngestionService_1 = __webpack_require__(11);
const IngestionVerifier_1 = __webpack_require__(17);
...
const GitService_1 = __webpack_require__(43);
const elevenlabs_1 = __webpack_require__(61);
const storage_1 = __webpack_require__(62);
// The ContextIngestionService is already imported above, so we don't duplicate it here.
// Import UI components
const StatusBarManager_1 = __webpack_require__(80);
const SidebarWebviewProvider_1 = __webpack_require__(81);
const IssuesTreeProvider_1 = __webpack_require__(83);
const NotificationManager_1 = __webpack_require__(84);
const CommandManager_1 = __webpack_require__(85);
const SessionManager_1 = __webpack_require__(89);
// Global state
let statusBar;
let sidebarProvider;
    ...
    console.log('Autonomous Copilot extension is now active!');
        ...
        try {
          ...
          // ignore
            ...
            const geminiApiKey = config.get('gemini.apiKey') || process.env.GEMINI_API_KEY || process.env.GEMINI_API_KEY || "";
            ...
            if (geminiApiKey) {
              ...
              try {
                ...
                console.warn("Failed to initialize Gemini Service, falling back to mocks:", initErr);
              }

              // Initialize storage & context using real services
              const storageService = new storage_1.LanceDBStorage();
              await storageService.connect(geminiService);
              console.log("Storage Service initialized");
              contextService = new ContextService_1.ContextService(storageService, aiService);
              const sessionManager = new SessionManager_1.SessionManager(storageService);
              ...
              ingestionService = new ContextIngestionService_1.ContextIngestionService(storageService, contextService, sessionManager);
              await ingestionService.initialize(context, outputChannel);
              console.log("Ingestion Service initialized");

              // Initialize Git Service
              const workspaceRoot = vscode.workspace.workspaceFolders?.[0]?.uri.fsPath;
              gitService = new GitService_1.GitService(workspaceRoot);

              // Initialize voice service if ElevenLabs key is present
              const elevenLabsApiKey = config.get('elevenlabs.apiKey') || process.env.ELEVEN_LABS_API_KEY || process.env.ELEVENLABS_API_KEY || "";
              const voiceEnabled = config.get('voice.enabled', true);
              ...
              commandManager = new CommandManager_1.CommandManager(context, contextService, aiService, voiceService, sidebarProvider, statusBar, issuesTreeProvider, storageService);
              commandManager.registerCommands();
              context.subscriptions.push(statusBar, treeView, webviewProvider, lintingService);

              // Initialize idle & autonomous components
              autonomousAgent = new AutonomousAgent_1.AutonomousAgent(gitService, geminiService, contextService);
              idleService = new idle_service_1.IdleService(storageService, { thresholdMs: 15000 }, geminiService);
              ...
              // Register test & verification commands
              ...
              console.log('ContextKeeper: Extension Activated (real services)');
            }
            else {
              // No Gemini API key — fall back to mocks and limited functionality
              console.warn("No Gemini API Key found. AI features will be disabled.");
              NotificationManager_1.NotificationManager.showError("Gemini API Key missing. Please set 'copilot.gemini.apiKey' in settings.");

              // Initialize mock services to keep UI responsive
              ...
              // UI initialization for mock mode
...
const linting_1 = __webpack_require__(10);
/**
...
function updateDiagnostics(doc, collection, issues) {
    const diagnostics = [];
...
const vscode = __importStar(__webpack_require__(1));
const path = __importStar(__webpack_require__(4));
const GitWatcher_1 = __webpack_require__(12);
const IngestionQueue_1 = __webpack_require__(15);
...
class ContextIngestionService {
    ...
    sessionManager;
    queue;
    constructor(storage, contextService, sessionManager) {
    ...
    async handleFileFocus(document) {
    ...
    async processFileEdit(document, changes) {
        try {
            ...
            try {
                const symbols = await (0, symbolUtils_1.getDocumentSymbols)(document.uri);
                console.log(`[ContextIngestion] Found ${symbols.length} symbols in ${relativePath}`);
                for (const change of changes) {
                    const func = (0, symbolUtils_1.findFunctionAtPosition)(symbols, change.range.start);
                    if (func) {
...
exports.IngestionQueue = IngestionQueue;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.findFunctionAtPosition = findFunctionAtPosition;
 ...
 */
function findFunctionAtPosition(symbols, pos) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.IngestionVerifier = void 0;
const vscode = __importStar(__webpack_require__(1));
class IngestionVerifier {
    ingestionService;
    storage;
    outputChannel;
    constructor(ingestionService, storage) {
...
exports.IngestionVerifier = IngestionVerifier;
...
const TaskRunner_1 = __webpack_require__(19);
const CloudflareService_1 = __webpack_require__(20);
const vscode = __importStar(__webpack_require__(1));
class AutonomousAgent {
    ...
    taskRegistry;
    cloudflareService;
    constructor(gitService, aiService, contextService) {
        this.gitService = gitService;
        this.aiService = aiService;
        this.contextService = contextService;
        this.taskRegistry = new TaskRunner_1.TaskRegistry();
        this.cloudflareService = new CloudflareService_1.CloudflareService();
    ...
    async runGenerateTests(context) {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            return;
        }
...
const node_fetch_1 = __importDefault(__webpack_require__(21));
const vscode = __importStar(__webpack_require__(1));
class CloudflareService {
    ...
    constructor(workerUrl) {
        ...
        this.workerUrl = workerUrl ||
            config.get('cloudflare.workerUrl') ||
    ...
    async lintCode(code, language) {
        ...
        try {
            ...
            const response = await (0, node_fetch_1.default)(this.workerUrl, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
...
/* harmony export */ });
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(23);
/* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
/* harmony import */ var whatwg_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(25);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(34);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(35);
...
exports.URL = __webpack_require__(26)["interface"];
exports.serializeURL = __webpack_require__(30).serializeURL;
exports.serializeURLOrigin = __webpack_require__(30).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(30).basicURLParse;
exports.setTheUsername = __webpack_require__(30).setTheUsername;
exports.setThePassword = __webpack_require__(30).setThePassword;
exports.serializeHost = __webpack_require__(30).serializeHost;
exports.serializeInteger = __webpack_require__(30).serializeInteger;
exports.parseURL = __webpack_require__(30).parseURL;
...
const conversions = __webpack_require__(27);
const utils = __webpack_require__(28);
const Impl = __webpack_require__(29);
...
const usm = __webpack_require__(30);
...
const tr46 = __webpack_require__(32);
...
var mappingTable = __webpack_require__(33);
...
class DashboardProvider {
    _extensionUri;
    _contextService;
    static viewType = 'contextkeeper.dashboard';
    _view;
    constructor(_extensionUri, _contextService) {
...
class IdleDetector extends events_1.EventEmitter {
    ...
    start() {
        ...
        this.resetTimer();
        try {
            this.disposables.push(vscode.window.onDidChangeWindowState(() => this.handleActivity('windowState')), vscode.window.onDidChangeTextEditorSelection(() => this.handleActivity('selection')), vscode.workspace.onDidChangeTextDocument(() => this.handleActivity('documentChange')), vscode.window.onDidChangeActiveTextEditor(() => this.handleActivity('activeEditor')));
...
class ContextService extends events_1.EventEmitter {
    ...
    async collectContext() {
        try {
            ...
            const geminiContext = await context_builder_1.ContextBuilder.build(rawInput, this.storage);
            // Log for debugging
    ...
    async getLatestContextSummary() {
        try {
            ...
            if (this.aiService && recentActions.length > 0) {
                const activityLog = recentActions.map(a => `- [${new Date(a.timestamp).toLocaleTimeString()}] ${a.description}`).join('\n');
                try {
    ...
    async collectCursorContext() {
        ...
        try {
            ...
            const symbols = await (0, symbolUtils_1.getDocumentSymbols)(editor.document.uri);
            if (symbols) {
...
class GeminiService extends events_1.EventEmitter {
    ...
    async analyze(code, context) {
      ...
      `;
            ...
            const analysis = {
                issues: analysisData.issues.map((i, idx) => ({
...
const simple_git_1 = __importDefault(__webpack_require__(44));
const vscode = __importStar(__webpack_require__(1));
class GitService {
    git;
    workspaceRoot;
    constructor(workspaceRoot) {
        ...
        this.git = (0, simple_git_1.default)(this.workspaceRoot);
    }
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    "use strict";
    import_node_buffer = __webpack_require__(45);
    import_file_exists = __webpack_require__(46);
...
var init_completion_detection_plugin = __esm({
  "src/lib/plugins/completion-detection.plugin.ts"() {
    "use strict";
    import_promise_deferred = __webpack_require__(58);
    init_utils();
...
var init_plugin_store = __esm({
  "src/lib/plugins/plugin-store.ts"() {
    "use strict";
    import_node_events = __webpack_require__(59);
    init_utils();
    PluginStore = class {
      constructor() {
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    "use strict";
    import_debug = __toESM(__webpack_require__(48));
    init_utils();
...
var init_git_executor_chain = __esm({
  "src/lib/runners/git-executor-chain.ts"() {
    "use strict";
    import_child_process = __webpack_require__(13);
    init_git_error();
    init_task();
    init_utils();
...
var init_scheduler = __esm({
  "src/lib/runners/scheduler.ts"() {
    "use strict";
    init_utils();
    import_promise_deferred2 = __webpack_require__(58);
    init_git_logger();
...
var init_CheckIgnore = __esm({
  "src/lib/responses/CheckIgnore.ts"() {
    "use strict";
    import_node_path = __webpack_require__(60);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(55);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(56);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57);
...
class ElevenLabsService {
    apiKey;
    initialized = false;
    voiceId = 'JBFqnCBsd6RMkjVDRZzb'; // Example Voice ID (George)
    constructor() { }
    initialize(apiKey) {
        if (!apiKey) {
...
const lancedb = __importStar(__webpack_require__(63));
...
class LanceDBStorage {
    ...
    async getSimilarActions(queryText, topK = 5) {
        if (!this.actionsTable) {
            throw new Error('Actions table not initialized');
        }
        const embedding = await this.getEmbedding(queryText);
...
/* harmony export */ });
/* harmony import */ var _v1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(65);
/* harmony import */ var _v3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70);
/* harmony import */ var _v4_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(74);
/* harmony import */ var _v5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(76);
/* harmony import */ var _nil_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(78);
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(79);
/* harmony import */ var _validate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(68);
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(67);
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(72);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66);
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(67);
...
/* harmony export */ });
/* harmony import */ var _validate_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(68);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(69);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71);
/* harmony import */ var _md5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73);
...
/* harmony export */ });
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67);
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(72);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66);
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
...
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71);
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77);
...
const dashboard_1 = __webpack_require__(82);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.dashboardHtml = void 0;
exports.dashboardHtml = `<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
const vscode = __importStar(__webpack_require__(1));
const NotificationManager_1 = __webpack_require__(84);
const gitlog_1 = __webpack_require__(86);
const fileWatcher_1 = __webpack_require__(88);
class CommandManager {
    ...
    issuesTreeProvider;
    storageService;
    constructor(context, contextService, aiService, voiceService, sidebarProvider, statusBar, issuesTreeProvider, storageService) {
    ...
    registerAnalysisCommands() {
        ...
        this.context.subscriptions.push(vscode.commands.registerCommand('copilot.resumeWork', async () => {
            await this.resumeWork();
        }));
        this.context.subscriptions.push(vscode.commands.registerCommand('copilot.startAutonomousSession', async () => {
    ...
    registerDebugCommands() {
        ...
        this.context.subscriptions.push(vscode.commands.registerCommand("contextkeeper.showStoredActions", async () => {
            try {
    ...
    async resumeWork() {
        try {
            ...
            NotificationManager_1.NotificationManager.showError(`Failed to resume work: ${error.message}`);
        }
    }
...
class GitService {
    ...
    async getRecentCommits(limit = 10) {
        try {
            ...
            const gitlogModule = await __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(__webpack_require__, 90));
            // @ts-ignore
...
class SessionManager {
    currentSessionId = 'current'; // Default fallback
    storage;
    initialized = false;
    constructor(storage) {
        this.storage = storage;
    ...
    async initialize() {
        ...
        try {
            ...
            const session = await this.storage.createSession(`Session started at ${new Date().toLocaleString()}`, workspaceName);
