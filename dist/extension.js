...
const ContextIngestionService_1 = __webpack_require__(8);
const AutonomousAgent_1 = __webpack_require__(14);
const DashboardProvider_1 = __webpack_require__(32);
// Import real services
const ContextService_1 = __webpack_require__(33);
const GeminiService_1 = __webpack_require__(34);
const GitService_1 = __webpack_require__(36);
const elevenlabs_1 = __webpack_require__(54);
const storage_1 = __webpack_require__(55);
// The ContextIngestionService is already imported above, so we don't duplicate it here.
// Import UI components
const StatusBarManager_1 = __webpack_require__(73);
const SidebarWebviewProvider_1 = __webpack_require__(74);
const IssuesTreeProvider_1 = __webpack_require__(76);
const NotificationManager_1 = __webpack_require__(77);
const CommandManager_1 = __webpack_require__(78);
const SessionManager_1 = __webpack_require__(84);
// Global state
let statusBar;
let sidebarProvider;
...
function activate(context) {
    ...
    try {
        ...
        contextService = new ContextService_1.ContextService(storageService); // Assign to global contextService
        const sessionManager = new SessionManager_1.SessionManager(storageService);
        // Initialize Session (Async)
        sessionManager.initialize().catch((err) => console.error("Failed to init session:", err));
        // Initialize Linting Service
        // lintingService = new LintingService(); // TODO: Implement real LintingService or use CloudflareService
        ...
        ingestionService.initialize(context).catch((err) => {
        ...
        commandManager = new CommandManager_1.CommandManager(context, contextService, aiService, voiceService, sidebarProvider, statusBar, issuesTreeProvider);
        ...
        const agent = new AutonomousAgent_1.AutonomousAgent(gitService, geminiService, contextService);
...
const vscode = __importStar(__webpack_require__(1));
const path = __importStar(__webpack_require__(4));
const GitWatcher_1 = __webpack_require__(9);
class ContextIngestionService {
    ...
    async processFileEdit(document, changes) {
        try {
            ...
            const description = `User edited ${relativePath} (${document.languageId}). Changed ${changes.length} sections.`;
            ...
            this.logToOutput(`[FILE_EDIT] ${relativePath} (${changes.length} changes)`);
        }
        catch (error) {
...
class GitService {
    ...
    async getRecentCommits(limit = 10) {
        try {
            ...
            const gitlogModule = await __webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(__webpack_require__, 85));
            // @ts-ignore
...
const TaskRunner_1 = __webpack_require__(15);
const CloudflareService_1 = __webpack_require__(16);
const vscode = __importStar(__webpack_require__(1));
class AutonomousAgent {
    ...
    async startSession(goal) {
        ...
        try {
            ...
            if (sessionGoal.includes('lint')) {
                await this.runTask('auto-lint', context);
            }
            else if (sessionGoal.includes('fix')) {
    ...
    async proposeAction(context) {
        ...
        // For "Thin Path", we'll use a simple heuristic or a direct prompt if we had a generic "ask" method
        // Since IAIService has specific methods, we might need to add a generic 'ask' or 'analyze' 
        // But let's use 'analyze' and check for issues.
        const analysis = await this.aiService.analyze(context.files.activeFile || '', context);
        if (analysis.issues.length > 0) {
            return 'fix-issues';
        }
        return 'auto-lint'; // Default fallback
    }
    async runAutoFix(context) {
        ...
        const errorText = document.getText(range);
        ...
        try {
            ...
            if (fix && fix.fixedCode) {
                // Apply the fix
                // Note: Gemini returns the *full* fixed code usually. 
                // Ideally we want a diff, but for "Thin Path" we might replace the whole file 
                // OR try to locate the change. 
                // Let's assume Gemini returns the FULL file content for now as per GeminiService implementation.
...
const node_fetch_1 = __importDefault(__webpack_require__(17));
class CloudflareService {
    workerUrl;
    constructor(workerUrl = 'https://contextkeeper-lint-worker.vishnu.workers.dev') {
    ...
    async lintCode(code, language) {
        ...
        try {
            ...
            console.error('Cloudflare linting failed:', error);
            return [];
        }
    }
}
...
/* harmony import */ var whatwg_url__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21);
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(30);
/* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31);
...
exports.URL = __webpack_require__(22)["interface"];
exports.serializeURL = __webpack_require__(26).serializeURL;
exports.serializeURLOrigin = __webpack_require__(26).serializeURLOrigin;
exports.basicURLParse = __webpack_require__(26).basicURLParse;
exports.setTheUsername = __webpack_require__(26).setTheUsername;
exports.setThePassword = __webpack_require__(26).setThePassword;
exports.serializeHost = __webpack_require__(26).serializeHost;
exports.serializeInteger = __webpack_require__(26).serializeInteger;
exports.parseURL = __webpack_require__(26).parseURL;
...
const conversions = __webpack_require__(23);
const utils = __webpack_require__(24);
const Impl = __webpack_require__(25);
...
const usm = __webpack_require__(26);
...
const punycode = __webpack_require__(27);
const tr46 = __webpack_require__(28);
...
var mappingTable = __webpack_require__(29);
...
class ContextService extends events_1.EventEmitter {
    ...
    async getLatestContextSummary() {
        try {
            ...
            const recentActions = await this.storage.getSimilarActions("recent edits and changes", 3);
...
const generative_ai_1 = __webpack_require__(35);
const events_1 = __webpack_require__(10);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GitService = void 0;
const simple_git_1 = __importDefault(__webpack_require__(37));
const vscode = __importStar(__webpack_require__(1));
class GitService {
    git;
    workspaceRoot;
...
var init_util = __esm({
  "src/lib/utils/util.ts"() {
    "use strict";
    import_node_buffer = __webpack_require__(38);
    import_file_exists = __webpack_require__(39);
...
var init_git_logger = __esm({
  "src/lib/git-logger.ts"() {
    "use strict";
    import_debug = __toESM(__webpack_require__(41));
    init_utils();
...
var init_git_executor_chain = __esm({
  "src/lib/runners/git-executor-chain.ts"() {
    "use strict";
    import_child_process = __webpack_require__(12);
    init_git_error();
    init_task();
    init_utils();
...
var init_CheckIgnore = __esm({
  "src/lib/responses/CheckIgnore.ts"() {
    "use strict";
    import_node_path = __webpack_require__(53);
...
const debug_1 = __importDefault(__webpack_require__(41));
...
try {
	...
	const supportsColor = __webpack_require__(47);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var node_process__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(48);
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49);
/* harmony import */ var node_tty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(50);
...
const lancedb = __importStar(__webpack_require__(56));
...
/* harmony export */ });
/* harmony import */ var _v1_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(58);
/* harmony import */ var _v3_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63);
/* harmony import */ var _v4_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67);
/* harmony import */ var _v5_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(69);
/* harmony import */ var _nil_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(71);
/* harmony import */ var _version_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(72);
/* harmony import */ var _validate_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(61);
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(60);
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(65);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64);
/* harmony import */ var _md5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(66);
...
/* harmony export */ });
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60);
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(65);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _native_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(68);
/* harmony import */ var _rng_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(59);
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(60);
...
/* harmony export */ });
/* harmony import */ var _v35_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64);
/* harmony import */ var _sha1_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(70);
...
const dashboard_1 = __webpack_require__(75);
...
const vscode = __importStar(__webpack_require__(1));
const NotificationManager_1 = __webpack_require__(77);
const storage_1 = __webpack_require__(79);
const gitlog_1 = __webpack_require__(82);
const fileWatcher_1 = __webpack_require__(83);
class CommandManager {
    ...
    statusBar;
    issuesTreeProvider;
    constructor(context, contextService, aiService, voiceService, sidebarProvider, statusBar, issuesTreeProvider) {
